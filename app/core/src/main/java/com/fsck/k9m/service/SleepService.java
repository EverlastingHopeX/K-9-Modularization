...
public class SleepService extends CoreService {
    ...
    private static final String ALARM_FIRED = "com.fsck.k9m.service.SleepService.ALARM_FIRED";
    private static final String LATCH_ID = "com.fsck.k9m.service.SleepService.LATCH_ID_EXTRA";
