...
import com.fsck.k9m.backend.api.MessageRemovalListener;
import com.fsck.k9m.crypto.EncryptionExtractor;
import com.fsck.k9m.crypto.EncryptionResult;
import com.fsck.k9m.helper.FileHelper;
...
import com.fsck.k9m.mail.filter.CountingOutputStream;
import com.fsck.k9m.mail.internet.BinaryTempFileBody;
...
import com.fsck.k9m.mail.internet.SizeAware;
import com.fsck.k9m.mail.message.MessageHeaderParser;
...
import com.fsck.k9m.message.extractors.PreviewResult.PreviewType;
...
public class LocalFolder extends Folder<LocalMessage> {
     ...
     * {@link com.fsck.k9m.controller.MessagingController#shouldNotifyForMessage} to see if messages being
