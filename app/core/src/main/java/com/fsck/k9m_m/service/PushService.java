...
public class PushService extends CoreService {
    private static final String START_SERVICE = "com.fsck.k9m_m.service.PushService.startService";
    private static final String STOP_SERVICE = "com.fsck.k9m_m.service.PushService.stopService";
