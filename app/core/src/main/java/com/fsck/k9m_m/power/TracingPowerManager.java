...
public class TracingPowerManager implements com.fsck.k9m_m.mail.power.PowerManager {
    ...
    @NotNull
    @Override
    public com.fsck.k9m_m.mail.power.WakeLock newWakeLock(@NotNull String tag) {
    ...
    public class TracingWakeLock implements com.fsck.k9m_m.mail.power.WakeLock {
