...
import com.fsck.k9m.mailstore.FileBackedBody;
import com.fsck.k9m.mailstore.LocalBodyPart;
...
public class MigrationTest extends K9RobolectricTest {
    ...
    private void insertMixedWithAttachments(SQLiteDatabase db) throws Exception {
        String[] statements = new String[] {
                ...
                "INSERT INTO attachments VALUES(3,3,'2'," +
                        "'content://com.fsck.k9m.attachmentprovider/" + account.getUuid() + "/3/RAW',2250," +
                        "'k9small.png','image/png',NULL,'attachment')",
                "INSERT INTO attachments VALUES(4,3,'2'," +
                        "'content://com.fsck.k9m.attachmentprovider/" + account.getUuid() + "/5/RAW',2250," +
    ...
    private void insertPgpMimeEncryptedMessage(SQLiteDatabase db) {
        String[] statements = new String[] {
                ...
                "INSERT INTO attachments VALUES(1,5,NULL,'content://com.fsck.k9m.attachmentprovider/" + account.getUuid() + "/1/RAW',12,NULL,'application/pgp-encrypted',NULL,'attachment')",
                "INSERT INTO attachments VALUES(2,5,NULL,'content://com.fsck.k9m.attachmentprovider/" + account.getUuid() + "/2/RAW',1946,'msg.asc','application/octet-stream',NULL,'attachment')",
        };
    ...
    private void insertHtmlWithRelatedMessage(SQLiteDatabase db) {
        String[] statements = new String[] {
                "INSERT INTO messages VALUES(9,0,16,'10','html with multipart/related content',1453922845000," +
                        ...
                        "    <img alt=\"Alternative_Text\" src=\"content://com.fsck.k9m.attachmentprovider/" + account.getUuid() + "/6/RAW\"\n" +
                ...
                "INSERT INTO attachments VALUES(6,9,NULL,'content://com.fsck.k9m.attachmentprovider/" + account.getUuid() + "/6/RAW'," +
