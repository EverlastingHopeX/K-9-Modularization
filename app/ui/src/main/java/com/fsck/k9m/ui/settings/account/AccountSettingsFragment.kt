...
import com.fsck.k9m.account.BackgroundAccountRemover
import com.fsck.k9m.activity.ManageIdentities
import com.fsck.k9m.activity.setup.AccountSetupComposition
import com.fsck.k9m.activity.setup.AccountSetupIncoming
import com.fsck.k9m.activity.setup.AccountSetupOutgoing
import com.fsck.k9m.controller.MessagingController
import com.fsck.k9m.crypto.OpenPgpApiHelper
import com.fsck.k9m.fragment.ConfirmationDialogFragment
import com.fsck.k9m.fragment.ConfirmationDialogFragment.ConfirmationDialogFragmentListener
import com.fsck.k9m.mailstore.Folder
import com.fsck.k9m.mailstore.FolderType
import com.fsck.k9m.mailstore.RemoteFolderInfo
import com.fsck.k9m.mailstore.StorageManager
import com.fsck.k9m.ui.R
import com.fsck.k9m.ui.account.NetworkReceiver
import com.fsck.k9m.ui.endtoend.AutocryptKeyTransferActivity
import com.fsck.k9m.ui.observe
import com.fsck.k9m.ui.settings.onClick
import com.fsck.k9m.ui.settings.oneTimeClickListener
import com.fsck.k9m.ui.settings.remove
import com.fsck.k9m.ui.settings.removeEntry
import com.fsck.k9m.ui.withArguments
    ...
    private fun configureEnablePgpSupport(account: Account, isPgpConfigured: Boolean, pgpProviderName: String?) {
        ...
        sw.onPreferenceChangeListener = object : Preference.OnPreferenceChangeListener {
            override fun onPreferenceChange(arg0: Preference, isVibrateOnObject: Any): Boolean {
                ...
                i.action = "com.fsck.k9m.SWITCH_STATE_CHANGE"
