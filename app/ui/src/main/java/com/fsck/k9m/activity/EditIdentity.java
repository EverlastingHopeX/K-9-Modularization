...
public class EditIdentity extends K9Activity {
    ...
    public static final String EXTRA_IDENTITY = "com.fsck.k9m.EditIdentity_identity";
    public static final String EXTRA_IDENTITY_INDEX = "com.fsck.k9m.EditIdentity_identity_index";
    public static final String EXTRA_ACCOUNT = "com.fsck.k9m.EditIdentity_account";
