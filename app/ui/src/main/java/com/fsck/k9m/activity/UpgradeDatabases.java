...
import com.fsck.k9m.service.DatabaseUpgradeService;
 ...
 * the locking in {@link com.fsck.k9m.mailstore.LocalStoreProvider#getInstance(Account)} the upgrade service will block
