...
import com.fsck.k9m.activity.loader.AttachmentContentLoader;
import com.fsck.k9m.activity.loader.AttachmentInfoLoader;
...
import com.fsck.k9m.message.Attachment.LoadingState;
import com.fsck.k9m.provider.RawMessageProvider;


public class AttachmentPresenter {
    private static final String STATE_KEY_ATTACHMENTS = "com.fsck.k9m.activity.MessageCompose.attachments";
    ...
    public List<com.fsck.k9m.message.Attachment> getAttachments() {
        return new ArrayList<com.fsck.k9m.message.Attachment>(attachments.values());
    }
