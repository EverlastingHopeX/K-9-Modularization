...
import com.fsck.k9m_m.service.DatabaseUpgradeService;
 ...
 * the locking in {@link com.fsck.k9m_m.mailstore.LocalStoreProvider#getInstance(Account)} the upgrade service will block
