...
import com.fsck.k9m_m.activity.loader.AttachmentContentLoader;
import com.fsck.k9m_m.activity.loader.AttachmentInfoLoader;
...
import com.fsck.k9m_m.message.Attachment.LoadingState;
import com.fsck.k9m_m.provider.RawMessageProvider;


public class AttachmentPresenter {
    private static final String STATE_KEY_ATTACHMENTS = "com.fsck.k9m_m.activity.MessageCompose.attachments";
    ...
    public List<com.fsck.k9m_m.message.Attachment> getAttachments() {
        return new ArrayList<com.fsck.k9m_m.message.Attachment>(attachments.values());
    }
