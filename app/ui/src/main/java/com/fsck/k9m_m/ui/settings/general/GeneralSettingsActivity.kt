package com.fsck.k9m_m.ui.settings.general
...
import com.fsck.k9m_m.activity.setup.FontSizeSettings
import com.fsck.k9m_m.ui.R
import com.fsck.k9m_m.ui.fragmentTransaction
import com.fsck.k9m_m.ui.fragmentTransactionWithBackStack
import com.fsck.k9m_m.ui.resolveAttribute
...
class GeneralSettingsActivity : K9Activity(), OnPreferenceStartScreenCallback, SearchPreferenceResultListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            ...
            searchQuery = savedInstanceState.getString(KEY_SEARCH_QUERY).toString()
