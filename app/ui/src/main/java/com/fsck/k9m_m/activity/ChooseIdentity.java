...
public class ChooseIdentity extends K9ListActivity {
    ...
    public static final String EXTRA_ACCOUNT = "com.fsck.k9m_m.ChooseIdentity_account";
    public static final String EXTRA_IDENTITY = "com.fsck.k9m_m.ChooseIdentity_identity";
